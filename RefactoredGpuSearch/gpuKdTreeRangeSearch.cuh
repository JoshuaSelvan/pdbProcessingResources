...
void gpuKdTreeUnoptimisedRangeSearchAllLoadedSets(std::string AtomA, std::string atomB, int requiredProximity, ProteinDataHandler heldProteinSets, AtomToNumHashTable);
