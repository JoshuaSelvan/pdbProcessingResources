...
void bruteForceRangeSearchAllLoadedSets(std::string atomA, std::string atomB, int requiredProximity, ProteinDataHandler heldProteinSets, AtomToNumHashTable atomReferenceTable)
{
	...
	int soughtAtomANumber = atomReferenceTable.retrieveHashValue(atomA);//heldProteinSets.ProteinDataHolder[0].namesSets[0];//1414;//
	int soughtAtomBNumber = atomReferenceTable.retrieveHashValue(atomB);//heldProteinSets.ProteinDataHolder[0].namesSets[1];//1514;//
